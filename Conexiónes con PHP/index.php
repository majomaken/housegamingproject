    ...
    <body>
        <header>
            <nav class="nav">
                ...
                <li>
                    <a href="">EQUIPOS</a>
                    <ul class="submenu">
                        <li><a href="apilol.php">Jugadores</a></li>
        ...
        <section>
            <article>
				...
				<section>
					<h2 id="palabra">JUEGOS EN LOS QUE PUEDES FORMAR TU EQUIPO PARA COMPETIR EN NUESTROS LOCALES</h2>
	        <div id="contentDiv">
	        ...
	        <div class="container-video">
	            <video src="assets/video/header1080" autoplay loop></video>
	        </div>
				</section>
