			...
			if (isset($league)) {
				...
				if ($datos2= json_decode($json2, true)) {
					...
					if ($datos2[0]["tier"]=="GOLD") {
						echo '<img src="images/images_api/3.png" />'."<br>";
					}
					else if ($datos2[0]["tier"]=="SILVER") {
							echo '<img src="images/images_api/2.png" />'."<br>";
						}
						else if ($datos2[0]["tier"]=="BRONZE") {
								echo '<img src="images/images_api/1.png" />'."<br>";
							}
							else if ($datos2[0]["tier"]=="PLATINUM") {
									echo '<img src="images/images_api/4.png" />'."<br>";
								}
								else if ($datos2[0]["tier"]=="DIAMOND") {
										echo '<img src="images/images_api/5.png" />'."<br>";
									}
									else if ($datos2[0]["tier"]=="MASTER") {
										echo '<img src="images/images_api/6.png" />'."<br>";
										}
										else if ($datos2[0]["tier"]=="CHALLENGER") {
											echo '<img src="images/images_api/7.png" />'."<br>";
											}
