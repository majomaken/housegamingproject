...
<body id="lo">
	<div id="cas">
		<?php
			...
			error_reporting(0);
			$key="RGAPI-303de6f1-2fb5-4ab6-a313-f21ac2d865b5";
			...
			if (isset($league)) {
				...
				if ($datos2= json_decode($json2, true)) {
					...
					switch ($datos2[0]["tier"]) {
						case 'BRONZE':
								echo '<img src="../images/images_api/ligas/1.png" />'."<br>";
							break;
						case 'SILVER':
								echo '<img src="../images/images_api/ligas/2.png" />'."<br>";
							break;
						case 'GOLD':
								echo '<img src="../images/images_api/ligas/3.png" />'."<br>";
							break;
						case 'PLATINUM':
								echo '<img src="images/images_api/ligas/4.png" />'."<br>";
							break;
						case 'DIAMOND':
								echo '<img src="../images/images_api/ligas/5.png" />'."<br>";
							break;
						case 'MASTER':
								echo '<img src="../images/images_api/ligas/6.png" />'."<br>";
							break;
						case 'CHALLENGER':
								echo '<img src="../images/images_api/ligas/7.png" />'."<br>";
							break;
					}
